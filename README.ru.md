...
| **Перевод** | Слева пишешь, справа появляется перевод — сам, офлайн, средствами macOS. Оба языка выбираются нажатием на заголовок колонки — их двадцать один, все, что переводит macOS, — а стрелки между колонками переворачивают перевод, возвращая результат во ввод. Без вмешательства это английский на русский, с автоматическим разворотом, когда набранное написано кириллицей. Языковые пакеты macOS не предустанавливает, поэтому первый раз их надо скачать: Системные настройки → Основные → Язык и регион → «Языки перевода…» |
